...
export function generateShotPlan(brief) {
  const {
    ...
    mood = "Authentic",
    visualStyle = "Documentary photojournalism",
    filmLook = "35mm natural grain",
    aspectRatio = "16:9"
  } = brief;
  ...
  const establishingShot = {
    id: "establishing",
    title: "1. Establishing Shot (Wide Context)",
    shotType: "Wide Angle Establishing Shot",
    description: "Establishes the environment, spatial scale, and context of the documentary setting.",
    ...
    prompt: constructPrompt({
      ...
      subjectAction: `establishing view of ${location} for a documentary on ${topic}, showing ${subject}`,
      environmentContext: `in the surrounding context of ${location}`,
      ...
      style: `${visualStyle}, candid documentary realism, strong sense of place, non-commercial editorial aesthetic`,
      aspectRatio
    }),
  ...
  const mediumShot = {
    id: "medium",
    title: "2. Medium / Interaction Shot (Human Relation)",
    shotType: "Medium 35mm Storytelling Shot",
    description: "Captures human action, emotional connection, and unposed interaction within the space.",
    ...
    prompt: constructPrompt({
      ...
      subjectAction: `${subject} engaged in authentic unposed action, depicting ${topic}`,
      ...
      style: `${visualStyle}, emotional authenticity, ${mood} atmosphere, human-centered photojournalism`,
      aspectRatio
    }),
    disclosureCaption: `Synthetic documentary image created with AI to illustrate ${topic}. This is not a photograph of a real person, event, or place.`
  };
  ...
  const detailShot = {
    id: "detail",
    title: "3. Detail Shot (Texture & Objects)",
    shotType: "Macro Close-Up Detail Shot",
    description: "Focuses on tactile textures, hands, tools, or emotional artifacts that deepen the story.",
    ...
    prompt: constructPrompt({
      ...
      subjectAction: `macro focus on hands, worn tools, textures, or key objects belonging to ${subject}`,
      ...
      style: `${visualStyle}, tactile emotional resonance, intimate observational documentary photography`,
      aspectRatio
    }),
    disclosureCaption: `Synthetic documentary image created with AI to illustrate ${topic}. This is not a photograph of a real person, event, or place.`
  };
...
function constructPrompt({
  ...
  const negativeAvoid = `Avoid: cartoon, 3D render, illustration, fake HDR, studio flash, perfect symmetry, airbrushed skin, commercial stock photo look, text overlay, watermark, extra fingers, distorted limbs, oversaturated colors.`;
