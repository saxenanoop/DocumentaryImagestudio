...
export function renderEthicsView() {
  ...
  return `
    <div class="container-narrow">
      <div style="margin-bottom: 2.75rem; text-align: center;">
        <span class="ethical-pill" style="margin-bottom: 1rem; display: inline-flex; align-items: center; gap: 0.4rem; background: var(--ethics-bg); color: var(--ethics-text); border-color: var(--ethics-border);">
        ...
        <h1 style="font-size: 2.65rem; margin-bottom: 0.75rem;">Ethical Use Guidelines</h1>
        <p class="text-muted" style="font-size: 1.1rem; max-width: 640px; margin: 0 auto; line-height: 1.6;">
      ...
      <div class="card" style="background: var(--ethics-bg); border: 2px solid var(--ethics-border); margin-bottom: 2.5rem; padding: 2rem;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
          <span style="font-size: 0.775rem; font-weight: 700; color: var(--ethics-text); text-transform: uppercase; letter-spacing: 0.06em; font-family: var(--font-mono); display: flex; align-items: center; gap: 0.4rem;">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>
            Recommended Standard Disclosure Caption
          </span>
          <button type="button" class="btn btn-secondary btn-sm btn-copy-caption" data-caption-text="${standardDisclosure}" style="background: var(--bg-surface);">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
            Copy Disclosure Snippet
          </button>
        </div>
        <div class="disclosure-text" style="font-size: 1.15rem; color: var(--ethics-text);">
          "${standardDisclosure}"
        </div>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 1.75rem;">
        ...
        <div class="card" style="padding: 1.85rem;">
          <h3 style="font-size: 1.35rem; margin-bottom: 0.75rem; color: var(--primary); display: flex; align-items: center; gap: 0.6rem; font-family: var(--font-serif);">
          ...
          <p class="text-muted" style="line-height: 1.65; font-size: 0.95rem;">
      ...
      <div style="text-align: center; margin-top: 3.25rem;">
